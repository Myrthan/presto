...
public class TestDateTimeFunctions
{
    ...
    public void testDateDiffTimestamp()
    {
        ...
        assertFunction("date_diff('millisecond', " + baseDateTimeLiteral + ", " + TIMESTAMP_LITERAL + ")", BIGINT, TIMESTAMP.getMillis() - baseDateTime.getMillis());
        ...
        assertFunction("date_diff('millisecond', " + weirdBaseDateTimeLiteral + ", " + WEIRD_TIMESTAMP_LITERAL + ")",
				BIGINT,
			 	WEIRD_TIMESTAMP.getMillis() - weirdBaseDateTime.getMillis());
    ...
    public void testDateDiffTime()
    {
        ...
        assertFunction("date_diff('millisecond', " + weirdBaseDateTimeLiteral + ", " + WEIRD_TIME_LITERAL + ")", BIGINT, WEIRD_TIME.getMillis() - weirdBaseDateTime.getMillis());
